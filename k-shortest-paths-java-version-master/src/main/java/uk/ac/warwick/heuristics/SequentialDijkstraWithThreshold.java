...
public class SequentialDijkstraWithThreshold extends SequentialDijkstra{
	...
	public SequentialDijkstraWithThreshold(MyVariableGraph graph, double threshold) {
		super(graph);
		this.setThreshold(threshold);
	}
	
	public SequentialDijkstraWithThreshold(MyVariableGraph graph, double threshold, Map<Edge, int[]> load) {
		super(graph, load);
		this.setThreshold(threshold);
	}
